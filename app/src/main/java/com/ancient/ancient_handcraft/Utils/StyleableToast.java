...
public class StyleableToast extends LinearLayout {
    ...
    private void inflateToastLayout() {
        View v = inflate(getContext(), R.layout.custom_styleable_toast_layout, null);
    ...
    public static class Builder {
        ...
        public Builder stroke(int strokeWidth, @ColorInt int strokeColor) {
            this.strokeWidth = AppUtils.Companion.toDp(context, strokeWidth);
        ...
        public Builder cornerRadius(int cornerRadius) {
            this.cornerRadius = AppUtils.Companion.toDp(context, cornerRadius);
            return this;
        }
