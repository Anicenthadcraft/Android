...
class FraturedRecyclerView(var mContext: Context, var itemList:ArrayList<Featured_item_model>, var onClickInf: OnFeaturedItemClickInterface) : RecyclerView.Adapter<FraturedRecyclerView.MyViewHolder>() {


    private var context: Context
    private var mItemList:ArrayList<Featured_item_model>
    private var mOnClickInf: OnFeaturedItemClickInterface
